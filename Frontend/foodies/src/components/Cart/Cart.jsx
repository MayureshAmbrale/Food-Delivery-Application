...
const Cart = () => {
    ...
    const { increaseQnt, decreaseQnt, quantities, foodList, removeFromCart } = useContext(StoreContext)
                ...
                <div className="col-lg-8">
                                            ...
                                            <div key={food.id} className="row cart-item mb-3">
                                                ...
                                                <div className="col-md-2">
                                                    <div className="input-group">
                                                        <button className="btn btn-outline-secondary btn-sm" type="button" onClick={()=>decreaseQnt(food.id)}>-</button>
                                                        ...
                                                        <button className="btn btn-outline-secondary btn-sm" type="button" onClick={()=>increaseQnt(food.id)}>+</button>
                                                    </div>
                                                </div>
                    ...
                    <div className="text-start mb-4">
                        <Link to={'/'} className="btn btn-outline-primary">
                            <i className="bi bi-arrow-left me-2"></i>Add Food
                        </Link>
                    </div>
                </div>
