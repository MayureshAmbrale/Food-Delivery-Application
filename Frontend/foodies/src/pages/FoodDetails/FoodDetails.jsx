...
const FoodDetails = () => {
  ...
  const navigate = useNavigate();
      ...
      const { increaseQnt, decreaseQnt } = useContext(StoreContext)
    ...
    <section className="py-5">
      <div className="container px-4 px-lg-5 my-5">
        <div className="row gx-4 gx-lg-5 align-items-center">
          <div className="col-md-6"><img className="card-img-top mb-5 mb-md-0" src={data.imageUrl} height={500}  alt="..." /></div>
